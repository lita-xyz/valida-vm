...
impl<M, SC> PairBuilder for ProverConstraintFolder<'_, M, SC>
where
    M: Machine<SC::Val>,
    SC: StarkConfig,
{
...
impl<M, SC> ExtensionBuilder for ProverConstraintFolder<'_, M, SC>
where
    M: Machine<SC::Val>,
    SC: StarkConfig,
{
...
impl<M, SC> ValidaAirBuilder for ProverConstraintFolder<'_, M, SC>
where
    M: Machine<SC::Val>,
    SC: StarkConfig,
{
...
impl<M, SC> AirBuilderWithPublicValues for ProverConstraintFolder<'_, M, SC>
where
    M: Machine<SC::Val>,
    SC: StarkConfig,
{
...
impl<M: Machine<SC::Val>, SC> AirBuilderWithGlobalPermutationChallenges
    for ProverConstraintFolder<'_, M, SC>
where
    M: Machine<SC::Val>,
    SC: StarkConfig,
{
...
impl<M, SC> ExtensionBuilder for VerifierConstraintFolder<'_, M, SC>
where
    M: Machine<SC::Val>,
    SC: StarkConfig,
{
...
impl<M, SC> PairBuilder for VerifierConstraintFolder<'_, M, SC>
where
    M: Machine<SC::Val>,
    SC: StarkConfig,
{
...
impl<M, SC> ValidaAirBuilder for VerifierConstraintFolder<'_, M, SC>
where
    M: Machine<SC::Val>,
    SC: StarkConfig,
{
...
impl<M, SC> AirBuilderWithPublicValues for VerifierConstraintFolder<'_, M, SC>
where
    M: Machine<SC::Val>,
    SC: StarkConfig,
{
...
impl<M: Machine<SC::Val>, SC> AirBuilderWithGlobalPermutationChallenges
    for VerifierConstraintFolder<'_, M, SC>
where
    M: Machine<SC::Val>,
    SC: StarkConfig,
{
